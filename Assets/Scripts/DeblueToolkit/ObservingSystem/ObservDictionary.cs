...
namespace Deblue.ObservingSystem
{
    ...
    {
        void SubscribeOnAdding(Action<Value_Added<Tkey, TValue>> action);
        void SubscribeOnRemoving(Action<Value_Removed<Tkey, TValue>> action);
        void SubscribeOnChanging(Action<Value_Changed<Tkey, TValue>> action);
    ...
    public class ObservDictionary<TKey, TValue> : EventSender, IReadonlyObservDictionary<TKey, TValue>, IDictionary<TKey, TValue>
    {
        ...
        #region Subscribing
        public void SubscribeOnAdding(Action<Value_Added<TKey, TValue>> action)
        {
            Subscribe(action);
        }

        public void SubscribeOnRemoving(Action<Value_Removed<TKey, TValue>> action)
        {
            Subscribe(action);
        }

        public void SubscribeOnChanging(Action<Value_Changed<TKey, TValue>> action)
        {
            Subscribe(action);
        }
        #endregion
